...
CREATE TABLE "Bcard" (
    ...
    CONSTRAINT "Bcard_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Bcardspecialization" (
    ...
    CONSTRAINT "Bcardspecialization_Bcard_id_fkey" FOREIGN KEY ("Bcard_id") REFERENCES "Bcard" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Bcardspecialization_specialization_id_fkey" FOREIGN KEY ("specialization_id") REFERENCES "Specialization" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Bcard_id_key" ON "Bcard"("id");
